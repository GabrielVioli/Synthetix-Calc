...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/calculator.css')); ?>">
...
<div class="calculator">
    ...
    <?php if(session('result')): ?>
        <div class="result">
            <strong>Resultado:</strong> <?php echo Str::markdown(session('result')); ?>
...
<?php /**PATH /home/gabriel/clones/Synthetix-Calc/resources/views/Calculator.blade.php ENDPATH**/ ?>